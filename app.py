...
# ---------------- NAME / PASSWORD ---------------- #
# Superscript digits for random name
SUPERSCRIPT = "⁰¹²³⁴⁵⁶⁷⁸⁹"
...
def generate_custom_password():
    """Generate random 64-character hex password (e.g., 4432EBBA2A4147B2A1CAADF8711EB1AAB1F651304FAA8BE45992B8B39486A66C)"""
    hex_chars = "0123456789ABCDEF"
    return ''.join(random.choice(hex_chars) for _ in range(64))

def reset_name_counter():
    """No longer needed for random names, kept for compatibility"""
    pass
...
def generate_accounts():
    ...
    # Reset name counter to start from ⁰⁰ for each request
    reset_name_counter()
